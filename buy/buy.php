...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($flag) {
		...
		// Prepare SQL query
		$sql = "INSERT INTO buy (FirstName,LastName, phone, email, wastetype, location,status) VALUES('$firstname','$lastname', '$phone', '$email', '$wastetype','$location','pending') ";
	...
	<div class="container">
		<div class="row">
			...
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<h2 class="text-center" style="color:black;"> BUY </h2>
