        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style='background-color:#37517e'>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="../index.html"><i class="fa fa-fw fa fa-question-circle"></i> Logout</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
   ...
   if($total!=0) {
     ...
     echo "
           ...
           <td>   ".$result['id']." </td>      
               ...
               <td><a href = 'admindelete1.php?i=$result[id] 'class='btn btn-danger'>Delete</a></td>
              <td> <a href = 'status1.php?i=$result[id]&s=$result[status] 'class='btn btn-success'>Status</a></td>
