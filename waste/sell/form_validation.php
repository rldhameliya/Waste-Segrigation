...
<head>
	...
	<link rel="stylesheet" href="sell.css" type="text/css">
	<title>Buy</title>
	<style type="text/css">
		.error {
			font-size: 15px;
...
<video autoplay muted loop id="myVideo">
        <source src="sell.mp4" type="video/mp4">
    </video>
<section>
	<div class="form">
	<form action=" <?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
		<div class="card pt-2_mx-auto" style="max-width: 30rem;">
			...
			<div class="card-body">
				...
				<div class="card-text mb-2" style="background-size: 20px;">
					<label>Make your choice <small>(optional)</small>:</label> <select class="form-select" name="state" data-bs-toggle="dropdown">
						<option value=""> Make your choice</option>
						<option <?= $state == 'Dry West' ? 'selected' : '' ?> value="Dry West" >Dry West</option>
						<option <?= $state == 'Wet West' ? 'selected' : '' ?> value="Wet West" >Wet West</option>
						<option <?= $state == 'E-waste' ? 'selected' : '' ?> value="E-waste" >E-waste</option>
						<option <?= $state == 'Medical West ' ? 'selected' : '' ?> value="Medical West " >Medical West </option>
					</select>
				</div>
			</div>
			<div class="btn">
				<input class="smt" type="submit" name="button">
			</div>
		</div>
	</form>
